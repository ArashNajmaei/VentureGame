...
Five built-in ventures spanning different business models — a **consumer app** (CampusEats),
a **marketplace** (FitMates), a **B2B tool** (LedgerLite), a **D2C physical product**
(EcoThreads) and a **workplace/B2B2C tool** (ShiftPal) — so students can replay and see the
same validation logic apply across very different businesses.

**The endings deliberately differ** — some ventures should be *persevered*, some *pivoted*, and
one is a **vanity-metrics trap** where the tempting "scale it!" answer is wrong. Students can't
just pattern-match "always persevere," and option order is **shuffled every play** so the right
answer isn't in a fixed slot. Each round is also **gated**: you can't advance until you've
actually made a choice and seen the feedback.
